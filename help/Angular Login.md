...
### <font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">1. 安装 axios（含类型声明）</font>
<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">在终端的</font>`<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">frontend-demo</font>`<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">目录下执行：</font>
...
### <font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">2. 安装 bootstrap</font>
<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">同样在</font>`<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">frontend-demo</font>`<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">目录下执行：</font>

```plain
npm install bootstrap
```

<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">安装完成后，重新运行</font>`<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">ng serve</font>`<font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">即可解决这两个依赖缺失的错误。</font>

### <font style="color:rgb(31, 35, 41);background-color:rgba(0, 0, 0, 0);">3.验证依赖是否添加</font>
